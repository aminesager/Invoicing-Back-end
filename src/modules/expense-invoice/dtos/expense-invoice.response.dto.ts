...
import { ResponseArticleExpenseInvoiceEntryDto } from './article-expense-invoice-entry.response.dto';
import { ResponseExpenseInvoiceMetaDataDto } from './expense-invoice-meta-data.response.dto';
import { ResponseExpenseInvoiceUploadDto } from './expense-invoice-upload.response.dto';

export class ResponseExpenseInvoiceDto {
  ...
  @ApiProperty({
    type: () => ResponseArticleExpenseInvoiceEntryDto,
    isArray: true,
  })
  articleExpenseInvoiceEntries?: ResponseArticleExpenseInvoiceEntryDto[];

  @ApiProperty({ type: () => ResponseExpenseInvoiceMetaDataDto })
  expenseInvoiceMetaData?: ResponseExpenseInvoiceMetaDataDto;

  @ApiProperty({ required: false })
  uploads?: ResponseExpenseInvoiceUploadDto[];
